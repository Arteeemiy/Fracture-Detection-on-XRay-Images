...
- **src/**: Основной код проекта.
  ...
  - **test.py**: Осуществляет тестирование модели на новых данных.
...
- **data/**: Папка с данными для обучения, валидации и тестирования.
...
На первом этапе был выполнен подбор гиперпараметров, таких как размер батча, скорость обучения и количество эпох. Для этого использовалась **кросс-валидация** для оценки разных комбинаций параметров и выбора оптимальных.
...
- **Кросс-валидация**: Данные были разбиты на несколько фолдов для кросс-валидации.
- **Гиперпараметры**:
  - Количество эпох: 30
...
Эти графики помогают визуализировать, как изменялись метрики модели на протяжении обучения и валидации.
